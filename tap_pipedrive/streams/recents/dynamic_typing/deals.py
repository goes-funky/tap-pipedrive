from tap_pipedrive.streams.recents.dynamic_typing import DynamicTypingRecentsStream, DynamicsDeals


class RecentDealsStream(DynamicsDeals):
    schema = 'deals'
    key_properties = ['id', ]
    state_field = ''
...
class RecentDeletedDealsStream(RecentDealsStream):
    key_properties = []
